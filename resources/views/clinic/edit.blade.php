<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            {{ __('Edit Clinic') }} :: {{ $clinic->id }}
        </h2>
    </x-slot>

    <x-container-layout>
        <x-form put :action="route('clinic.update', $clinic)" class="mx-auto max-w-sm">
            @method('PUT')
            <div class="mb-5">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="name_clinic" name="name_clinic"
                        ...
                        placeholder="Medical Clinical Example" value="{{ old('name_clinic', $clinic->name_clinic) }}"
                        required />
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <input type="text" id="CNPJ" name="CNPJ"
                    ...
                    value="{{ old('CNPJ', $clinic->CNPJ) }}" required />
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="email" name="email"
                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                        placeholder="name@example.com" value="{{ old('email', $clinic->email) }}" required />
                </div>
            </div>
